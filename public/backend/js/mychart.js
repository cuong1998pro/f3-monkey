(function() {
    ...
    */
    ...
    function ba(a) { if (!(a instanceof Array)) { a = n(a); for (var b, c = []; !(b = a.next()).done;) c.push(b.value);
            a = c } return a }
    var ca = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, b, c) { a != Array.prototype && a != Object.prototype && (a[b] = c.value) };

    function da(a) { a = ["object" == typeof globalThis && globalThis, a, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global]; for (var b = 0; b < a.length; ++b) { var c = a[b]; if (c && c.Math == Math) return c } throw Error("Cannot find global object"); }
    var ea = da(this);

    function fa(a, b) { if (b) { var c = ea;
    ...
    fa("Promise", function(a) {
        function b(f) { this.b = 0;
            this.c = void 0;
            this.a = []; var h = this.f(); try { f(h.resolve, h.reject) } catch (k) { h.reject(k) } }

        function c() { this.a = null }

        function d(f) { return f instanceof b ? f : new b(function(h) { h(f) }) }
        if (a) return a;
        c.prototype.b = function(f) { if (null == this.a) { this.a = []; var h = this;
                this.c(function() { h.h() }) }
            this.a.push(f) };
        var e = ea.setTimeout;
        ...
        b.prototype.f = function() {
            function f(m) { return function(t) { k || (k = !0, m.call(h, t)) } } var h = this,
                k = !1; return { resolve: f(this.u), reject: f(this.h) } };
        b.prototype.u = function(f) { if (f === this) this.h(new TypeError("A Promise cannot resolve to itself"));
            else if (f instanceof b) this.B(f);
                    ...
                    default:
                        h = !1 }
                h ? this.s(f) : this.i(f) } };
        b.prototype.s = function(f) { var h = void 0; try { h = f.then } catch (k) { this.h(k); return } "function" == typeof h ? this.C(h, f) : this.i(f) };
        b.prototype.h = function(f) { this.j(2, f) };
        b.prototype.i = function(f) { this.j(1, f) };
        b.prototype.j = function(f, h) { if (0 != this.b) throw Error("Cannot settle(" + f + ", " + h + "): Promise already settled in state" + this.b);
            this.b = f;
            this.c = h;
            this.l() };
        b.prototype.l = function() { if (null != this.a) { for (var f = 0; f < this.a.length; ++f) g.b(this.a[f]);
                this.a = null } };
        var g = new c;
        ...
        b.prototype.C = function(f, h) { var k = this.f(); try { f.call(h, k.resolve, k.reject) } catch (m) { k.reject(m) } };
        b.prototype.then = function(f, h) {
            function k(w, A) { return "function" == typeof w ? function(qa) { try { m(w(qa)) } catch (ra) { t(ra) } } : A } var m, t, sa = new b(function(w, A) { m = w;
                t = A });
            this.A(k(f, m), k(h, t)); return sa };
        b.prototype.catch = function(f) { return this.then(void 0, f) };
        b.prototype.A = function(f, h) {
            function k() {
                switch (m.b) {
                    case 1:
                        f(m.c);
        ...
        b.race = function(f) { return new b(function(h, k) { for (var m = n(f), t = m.next(); !t.done; t = m.next()) d(t.value).A(h, k) }) };
        b.all = function(f) { var h = n(f),
                k = h.next(); return k.done ? d([]) : new b(function(m, t) {
                function sa(qa) { return function(ra) { w[qa] = ra;
                        A--;
                        0 == A && m(w) } } var w = [],
                    A = 0;
                do w.push(void 0), A++, d(k.value).A(sa(w.length - 1), t), k = h.next(); while (!k.done) }) };
        return b
    });
    fa("Object.is", function(a) { return a ? a : function(b, c) { return b === c ? 0 !== b || 1 / b === 1 / c : b !== b && c !== c } });
    fa("Array.prototype.includes", function(a) { return a ? a : function(b, c) { var d = this;
    ...
    function q(a) { a = a.split("."); for (var b = p, c = 0; c < a.length; c++)
    ...
    function v(a) { return "function" == u(a) }

    function ja(a) { var b = typeof a; return "object" == b && null != a || "function" == b }

    function ka(a, b, c) { return a.call.apply(a.bind, arguments) }

    function la(a, b, c) { if (!a) throw Error(); if (2 < arguments.length) { var d = Array.prototype.slice.call(arguments, 2); return function() { var e = Array.prototype.slice.call(arguments);
                Array.prototype.unshift.apply(e, d); return a.apply(b, e) } } return function() { return a.apply(b, arguments) } }

    function x(a, b, c) { Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? x = ka : x = la; return x.apply(null, arguments) }

    function y(a, b) { a = a.split("."); var c = p;
    ...
    function B(a) { if (Error.captureStackTrace) Error.captureStackTrace(this, B);
    ...
    function C(a, b) { this.a = a === ma && b || "";
        this.b = na }
    C.prototype.G = !0;
    C.prototype.F = function() { return this.a };

    function oa(a) { return a instanceof C && a.constructor === C && a.b === na ? a.a : "type_error:Const" }

    function D(a) { return new C(ma, a) }
    var na = {},
        ma = {},
        pa = D("");
    var E = { g: {} };
    E.g.N = {
        ...
        ra: { d3: { subdir1: "d3", subdir2: "v5", filename: "d3.js" }, "d3.sankey": { subdir1: "d3_sankey", subdir2: "v4", filename: "d3.sankey.js" }, webfontloader: { subdir: "webfontloader", filename: "webfont.js" } },
        qa: { dygraph: { subdir: "dygraphs", filename: "dygraph-tickers-combined.js" }, vegaLib: { subdir: "vega", filename: "vega-bundle.js" } },
        $: {
    ...
    function ya(a, b) { for (var c = 1; c < arguments.length; c++) { var d = arguments[c],
                e = d,
                g = u(e); if ("array" == g || "object" == g && "number" == typeof e.length) { e = a.length || 0;
                g = d.length || 0;
                a.length = e + g; for (var f = 0; f < g; f++) a[e + f] = d[f] } else a.push(d) } };

    function F(a, b) { this.a = a === za && b || "";
        this.b = Aa }
    F.prototype.G = !0;
    F.prototype.F = function() { return this.a.toString() };

    function G(a) { if (a instanceof F && a.constructor === F && a.b === Aa) return a.a;
        u(a); return "type_error:TrustedResourceUrl" }

    function Ba(a, b) { var c = oa(a); if (!Ca.test(c)) throw Error("Invalid TrustedResourceUrl format: " + c);
        a = c.replace(Da, function(d, e) { if (!Object.prototype.hasOwnProperty.call(b, e)) throw Error('Found marker, "' + e + '", in format string, "' + c + '", but no valid label mapping found in args: ' + JSON.stringify(b));
            d = b[e]; return d instanceof C ? oa(d) : encodeURIComponent(String(d)) }); return new F(za, a) }
    var Da = /%{(\w+)}/g,
        Ca = /^((https:)?\/\/[0-9a-z.:[\]-]+\/|\/[^/\\]|[^:/\\%]+\/|[^:/\\%]*[?#]|about:blank#)/i,
        Ea = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/;

    function Fa(a, b, c) { a = Ba(a, b);
        a = G(a).toString();
        a = Ea.exec(a);
        b = a[3] || ""; return new F(za, a[1] + Ga("?", a[2] || "", c) + Ga("#", b, void 0)) }
    var Aa = {};

    function Ga(a, b, c) { if (null == c) return b; if ("string" === typeof c) return c ? a + encodeURIComponent(c) : ""; for (var d in c) { var e = c[d];
            e = Array.isArray(e) ? e : [e]; for (var g = 0; g < e.length; g++) { var f = e[g];
                null != f && (b || (b = a), b += (b.length > a.length ? "&" : "") + encodeURIComponent(d) + "=" + encodeURIComponent(String(f))) } } return b }
    var za = {};
    ...
    var H;
    a: { var Ja = p.navigator; if (Ja) { var Ka = Ja.userAgent; if (Ka) { H = Ka; break a } }
        H = "" }

    function I(a) { return -1 != H.indexOf(a) };

    function La(a, b) { for (var c in a) b.call(void 0, a[c], c, a) }
    var Ma = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");

    function Na(a, b) { for (var c, d, e = 1; e < arguments.length; e++) { d = arguments[e]; for (c in d) a[c] = d[c]; for (var g = 0; g < Ma.length; g++) c = Ma[g], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]) } };

    function J() { this.a = "";
        this.b = Oa }
    J.prototype.G = !0;
    J.prototype.F = function() { return this.a.toString() };

    function Pa() { var a = Qa; if (a instanceof J && a.constructor === J && a.b === Oa) return a.a;
        u(a); return "type_error:SafeHtml" }
    var Oa = {};

    function Ra(a) { var b = new J;
        b.a = a; return b }
    Ra("<!DOCTYPE html>");
    var Qa = Ra("");
    Ra("<br>");

    function Sa(a, b) { a.src = G(b); if (null === ia) b: { b = p.document; if ((b = b.querySelector && b.querySelector("script[nonce]")) && (b = b.nonce || b.getAttribute("nonce")) && ha.test(b)) { ia = b; break b }
            ia = "" }
        b = ia;
        b && a.setAttribute("nonce", b) };

    function Ta(a) { var b = Ua; return Object.prototype.hasOwnProperty.call(b, 11) ? b[11] : b[11] = a(11) };
    var Va = I("Opera"),
        Wa = I("Trident") || I("MSIE"),
        Xa = I("Edge"),
        Ya = I("Gecko") && !(-1 != H.toLowerCase().indexOf("webkit") && !I("Edge")) && !(I("Trident") || I("MSIE")) && !I("Edge"),
        Za = -1 != H.toLowerCase().indexOf("webkit") && !I("Edge"),
        $a;
    a: { var ab = "",
            bb = function() { var a = H; if (Ya) return /rv:([^\);]+)(\)|;)/.exec(a); if (Xa) return /Edge\/([\d\.]+)/.exec(a); if (Wa) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (Za) return /WebKit\/(\S+)/.exec(a); if (Va) return /(?:Version)[ \/]?(\S+)/.exec(a) }();bb && (ab = bb ? bb[1] : ""); if (Wa) { var cb, db = p.document;
            cb = db ? db.documentMode : void 0; if (null != cb && cb > parseFloat(ab)) { $a = String(cb); break a } }
        $a = ab }
    var eb = $a,
        Ua = {};

    function fb() { return Ta(function() { for (var a = 0, b = Ha(String(eb)).split("."), c = Ha("11").split("."), d = Math.max(b.length, c.length), e = 0; 0 == a && e < d; e++) { var g = b[e] || "",
                    f = c[e] || "";
                do { g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
    ...
    function gb(a, b) { La(b, function(c, d) { c && "object" == typeof c && c.G && (c = c.F()); "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : hb.hasOwnProperty(d) ? a.setAttribute(hb[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c }) }
    var hb = { cellpadding: "cellPadding", cellspacing: "cellSpacing", colspan: "colSpan", frameborder: "frameBorder", height: "height", maxlength: "maxLength", nonce: "nonce", role: "role", rowspan: "rowSpan", type: "type", usemap: "useMap", valign: "vAlign", width: "width" };

    function ib(a) { var b = document;
        a = String(a); "application/xhtml+xml" === b.contentType && (a = a.toLowerCase()); return b.createElement(a) };

    function jb(a, b) { this.c = a;
        this.f = b;
        this.b = 0;
        this.a = null }
    jb.prototype.get = function() { if (0 < this.b) { this.b--; var a = this.a;
            this.a = a.next;
    ...
    function lb(a) { p.setTimeout(function() { throw a; }, 0) }
    var mb;
    ...
    function nb() {
        ...
        if ("undefined" !== typeof a && !I("Trident") && !I("MSIE")) { var b = new a,
                c = {},
                d = c;
            b.port1.onmessage = function() { if (void 0 !== c.next) { c = c.next; var e = c.J;
                    c.J = null;
                    e() } }; return function(e) { d.next = { J: e };
                d = d.next;
                b.port2.postMessage(0) } }
        return function(e) { p.setTimeout(e, 0) }
    };

    function ob() { this.b = this.a = null }
    var qb = new jb(function() { return new pb }, function(a) { a.reset() });
    ob.prototype.add = function(a, b) { var c = qb.get();
        c.set(a, b);
        this.b ? this.b.next = c : this.a = c;
        this.b = c };

    function rb() { var a = sb,
            b = null;
        a.a && (b = a.a, a.a = a.a.next, a.a || (a.b = null), b.next = null); return b }

    function pb() { this.next = this.b = this.a = null }
    pb.prototype.set = function(a, b) { this.a = a;
        this.b = b;
        this.next = null };
    pb.prototype.reset = function() { this.next = this.b = this.a = null };

    function tb(a, b) { ub || vb();
        wb || (ub(), wb = !0);
        sb.add(a, b) }
    var ub;

    function vb() { if (p.Promise && p.Promise.resolve) { var a = p.Promise.resolve(void 0);
            ub = function() { a.then(xb) } } else ub = function() { var b = xb;!v(p.setImmediate) || p.Window && p.Window.prototype && !I("Edge") && p.Window.prototype.setImmediate == p.setImmediate ? (mb || (mb = nb()), mb(b)) : p.setImmediate(b) } }
    var wb = !1,
        sb = new ob;

    function xb() { for (var a; a = rb();) { try { a.a.call(a.b) } catch (b) { lb(b) }
            kb(qb, a) }
        wb = !1 };

    function yb(a) { if (!a) return !1; try { return !!a.$goog_Thenable } catch (b) { return !1 } };

    function K(a) { this.a = 0;
        this.j = void 0;
        this.f = this.b = this.c = null;
        this.h = this.i = !1; if (a != r) try { var b = this;
            a.call(void 0, function(c) { L(b, 2, c) }, function(c) { L(b, 3, c) }) } catch (c) { L(this, 3, c) } }

    function zb() { this.next = this.c = this.b = this.f = this.a = null;
        this.h = !1 }
    zb.prototype.reset = function() { this.c = this.b = this.f = this.a = null;
        this.h = !1 };
    var Ab = new jb(function() { return new zb }, function(a) { a.reset() });

    function Bb(a, b, c) { var d = Ab.get();
        d.f = a;
        d.b = b;
        d.c = c; return d }
    K.prototype.then = function(a, b, c) { return Cb(this, v(a) ? a : null, v(b) ? b : null, c) };
    K.prototype.$goog_Thenable = !0;
    K.prototype.cancel = function(a) { if (0 == this.a) { var b = new M(a);
            tb(function() { Db(this, b) }, this) } };

    function Db(a, b) { if (0 == a.a)
            if (a.c) { var c = a.c; if (c.b) { for (var d = 0, e = null, g = null, f = c.b; f && (f.h || (d++, f.a == a && (e = f), !(e && 1 < d))); f = f.next) e || (g = f);
                    e && (0 == c.a && 1 == d ? Db(c, b) : (g ? (d = g, d.next == c.f && (c.f = d), d.next = d.next.next) : Eb(c), Fb(c, e, 3, b))) }
                a.c = null } else L(a, 3, b) }

    function Gb(a, b) { a.b || 2 != a.a && 3 != a.a || Hb(a);
        a.f ? a.f.next = b : a.b = b;
        a.f = b }

    function Cb(a, b, c, d) { var e = Bb(null, null, null);
        e.a = new K(function(g, f) { e.f = b ? function(h) { try { var k = b.call(d, h);
                    g(k) } catch (m) { f(m) } } : g;
            e.b = c ? function(h) { try { var k = c.call(d, h);
                    void 0 === k && h instanceof M ? f(h) : g(k) } catch (m) { f(m) } } : f });
        e.a.c = a;
        Gb(a, e); return e.a }
    K.prototype.s = function(a) { this.a = 0;
        L(this, 2, a) };
    K.prototype.u = function(a) { this.a = 0;
        L(this, 3, a) };

    function L(a, b, c) { if (0 == a.a) { a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself"));
            a.a = 1;
            a: { var d = c,
                    e = a.s,
                    g = a.u; if (d instanceof K) { Gb(d, Bb(e || r, g || null, a)); var f = !0 } else if (yb(d)) d.then(e, g, a), f = !0;
                else { if (ja(d)) try { var h = d.then; if (v(h)) { Ib(d, h, e, g, a);
    ...
    function Hb(a) { a.i || (a.i = !0, tb(a.l, a)) }

    function Eb(a) { var b = null;
        a.b && (b = a.b, a.b = b.next, b.next = null);
        a.b || (a.f = null); return b }
    K.prototype.l = function() { for (var a; a = Eb(this);) Fb(this, a, this.a, this.j);
        this.i = !1 };

    function Fb(a, b, c, d) { if (3 == c && b.b && !b.h)
            for (; a && a.h; a = a.c) a.h = !1; if (b.a) b.a.c = null, Kb(b, c, d);
        else try { b.h ? b.f.call(b.c) : Kb(b, c, d) } catch (e) { Lb.call(null, e) }
        kb(Ab, b) }

    function Kb(a, b, c) { 2 == b ? a.f.call(a.c, c) : a.b && a.b.call(a.c, c) }

    function Jb(a, b) { a.h = !0;
        tb(function() { a.h && Lb.call(null, b) }) }
    var Lb = lb;

    function M(a) { B.call(this, a) }
    z(M, B);
    ...
    */
    function N(a, b) { this.h = [];
        ...
        this.b = null;
        this.l = 0 }
    N.prototype.cancel = function(a) { if (this.a) this.c instanceof N && this.c.cancel();
        else { if (this.b) { var b = this.b;
                delete this.b;
                a ? b.cancel(a) : (b.l--, 0 >= b.l && b.cancel()) }
            this.C ? this.C.call(this.B, this) : this.s = !0;
            this.a || (a = new O(this), P(this), Q(this, !1, a)) } };
    N.prototype.u = function(a, b) { this.j = !1;
        Q(this, a, b) };

    function Q(a, b, c) { a.a = !0;
        a.c = c;
        a.f = !b;
        Mb(a) }

    function P(a) { if (a.a) { if (!a.s) throw new Nb(a);
            a.s = !1 } }

    function R(a, b, c, d) { a.h.push([b, c, d]);
        a.a && Mb(a); return a }
    N.prototype.then = function(a, b, c) { var d, e, g = new K(function(f, h) { d = f;
            e = h });
        R(this, d, function(f) { f instanceof O ? g.cancel() : e(f) }); return g.then(a, b, c) };
    N.prototype.$goog_Thenable = !0;

    function Ob(a) { return va(a.h, function(b) { return v(b[1]) }) }

    function Mb(a) {
        if (a.i && a.a && Ob(a)) { var b = a.i,
                c = Pb[b];
            c && (p.clearTimeout(c.a), delete Pb[b]);
            a.i = 0 }
        a.b && (a.b.l--, delete a.b);
        b = a.c;
        for (var d = c = !1; a.h.length && !a.j;) { var e = a.h.shift(),
                g = e[0],
                f = e[1];
            e = e[2]; if (g = a.f ? f : g) try { var h = g.call(e || a.B, b);
                void 0 !== h && (a.f = a.f && (h == b || h instanceof Error), a.c = b = h); if (yb(b) || "function" === typeof p.Promise && b instanceof p.Promise) d = !0, a.j = !0 } catch (k) { b = k, a.f = !0, Ob(a) || (c = !0) } }
        a.c = b;
    ...
    function Rb() { var a = new N;
        P(a);
        Q(a, !0, null); return a }

    function Nb() { B.call(this) }
    z(Nb, B);
    ...
    function Qb(a) { this.a = p.setTimeout(x(this.c, this), 0);
        this.b = a }
    Qb.prototype.c = function() { delete Pb[this.a]; throw this.b; };
    var Pb = {};
    var Sb, Tb = [];
    ...
    function Ub(a, b) {
        function c() { var e = a.shift();
            e = Vb(e, b);
            a.length && R(e, c, c, void 0); return e } if (!a.length) return Rb(); var d = Tb.length;
        ya(Tb, a); if (d) return Sb;
        a = Tb; return Sb = c() }
    ...
    function Vb(a, b) {
        ...
        0 < k && (h = window.setTimeout(function() { Xb(e, !0); var m = new Yb(1, "Timeout reached for loading script " + d);
            P(f);
            Q(f, !1, m) }, k), g.M = h);
        e.onload = e.onreadystatechange = function() { e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Xb(e, c.Z || !1, h), P(f), Q(f, !0, null)) };
        e.onerror = function() {
            Xb(e, !0, h);
    ...
    function Zb(a) { var b; return (b = (a || document).getElementsByTagName("HEAD")) && 0 != b.length ? b[0] : a.documentElement }

    function Wb() { if (this && this.K) { var a = this.K;
            a && "SCRIPT" == a.tagName && Xb(a, !0, this.M) } }

    function Xb(a, b, c) { null != c && p.clearTimeout(c);
        a.onload = r;
        a.onerror = r;
        a.onreadystatechange = r;
        b && window.setTimeout(function() { a && a.parentNode && a.parentNode.removeChild(a) }, 0) }

    function Yb(a, b) { var c = "Jsloader error (code #" + a + ")";
        b && (c += ": " + b);
        B.call(this, c);
        this.code = a }
    z(Yb, B);
    ...
    function cc(a) { return Fa(a.format, a.I, a.U || {}) }

    function ac(a, b, c) { c = c || {};
        a = Fa(a, b, c); var d = $b(a, { timeout: 3E4, attributes: { async: !1, defer: !1 } }); return new Promise(function(e) { R(d, e, null, void 0) }) }
    E.g.m.ma = function(a) { ac = a };
    E.g.m.pa = function(a) { $b = a };
    E.g.m.P = cc;
    E.g.m.load = bc;
    E.g.m.ha = function(a) { a = ua(a, cc); if (0 == a.length) return Promise.resolve(); var b = { timeout: 3E4, attributes: { async: !1, defer: !1 } },
            c = [];!Wa || fb() ? ta(a, function(d) { c.push($b(d, b)) }) : c.push(Ub(a, b)); return Promise.all(ua(c, function(d) { return new Promise(function(e) { return R(d, e, null, void 0) }) })) };
    E.g.m.ja = function(a, b, c) { return { format: a, I: b, U: c } };
    E.g.o = {};
    var S = {};
    E.g.o.ca = function(a) { return S[a] && S[a].loaded };
    E.g.o.da = function(a) { return S[a] && S[a].V };
    E.g.o.S = function() { return new Promise(function(a) { "undefined" == typeof window || "complete" === document.readyState ? a() : window.addEventListener ? (document.addEventListener("DOMContentLoaded", a, !0), window.addEventListener("load", a, !0)) : window.attachEvent ? window.attachEvent("onload", a) : v(window.onload) ? window.onload = function(b) { window.onload(b);
                a() } : window.onload = a }) };
    E.g.o.ia = S;
    E.g.o.la = function() { S = {} };
    E.g.o.na = function(a) { S[a] || (S[a] = { loaded: !1 });
        S[a].loaded = !0 };
    E.g.o.oa = function(a, b) { S[a] = { V: b, loaded: !1 } };
    E.g.H = { 1: "1.0", "1.0": "current", "1.1": "upcoming", 41: "pre-45", 42: "pre-45", 43: "pre-45", 44: "pre-45", 46: "46.1", "46.1": "46.2", current: "47", upcoming: "48", testing: "48" };

    function dc(a, b) { this.b = {};
        this.a = [];
        this.c = 0; var c = arguments.length; if (1 < c) { if (c % 2) throw Error("Uneven number of arguments"); for (var d = 0; d < c; d += 2) this.set(arguments[d], arguments[d + 1]) } else if (a)
            if (a instanceof dc)
                for (c = a.v(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
                for (d in a) this.set(d, a[d]) }
    l = dc.prototype;
    l.w = function() { ec(this); for (var a = [], b = 0; b < this.a.length; b++) a.push(this.b[this.a[b]]); return a };
    l.v = function() { ec(this); return this.a.concat() };

    function ec(a) { if (a.c != a.a.length) { for (var b = 0, c = 0; b < a.a.length;) { var d = a.a[b];
                T(a.b, d) && (a.a[c++] = d);
                b++ }
            a.a.length = c } if (a.c != a.a.length) { var e = {}; for (c = b = 0; b < a.a.length;) d = a.a[b], T(e, d) || (a.a[c++] = d, e[d] = 1), b++;
            a.a.length = c } }
    l.get = function(a, b) { return T(this.b, a) ? this.b[a] : b };
    l.set = function(a, b) { T(this.b, a) || (this.c++, this.a.push(a));
        this.b[a] = b };
    l.forEach = function(a, b) { for (var c = this.v(), d = 0; d < c.length; d++) { var e = c[d],
                g = this.get(e);
            a.call(b, g, e, this) } };
    ...
    function gc(a, b) { if (a) { a = a.split("&"); for (var c = 0; c < a.length; c++) { var d = a[c].indexOf("="),
                    e = null; if (0 <= d) { var g = a[c].substring(0, d);
                    e = a[c].substring(d + 1) } else g = a[c];
                b(g, e ? decodeURIComponent(e.replace(/\+/g, " ")) : "") } } };

    function U(a) { this.a = this.j = this.f = "";
        this.l = null;
        this.h = this.b = "";
        this.i = !1; var b;
    ...
    U.prototype.toString = function() { var a = [],
            b = this.f;
        b && a.push(lc(b, mc, !0), ":"); var c = this.a; if (c || "file" == b) a.push("//"), (b = this.j) && a.push(lc(b, mc, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.l, null != c && a.push(":", String(c)); if (c = this.b) this.a && "/" != c.charAt(0) && a.push("/"), a.push(lc(c, "/" == c.charAt(0) ? nc : oc, !0));
        (c = this.c.toString()) && a.push("?", c);
        (c = this.h) && a.push("#", lc(c, pc)); return a.join("") };
    ...
    function hc(a, b, c) { a.f = c ? V(b, !0) : b;
        a.f && (a.f = a.f.replace(/:$/, "")) }

    function ic(a, b) { if (b) { b = Number(b); if (isNaN(b) || 0 > b) throw Error("Bad port number " + b);
            a.l = b } else a.l = null }

    function jc(a, b, c) { b instanceof W ? (a.c = b, qc(a.c, a.i)) : (c || (b = lc(b, rc)), a.c = new W(b, a.i)) }

    function V(a, b) { return a ? b ? decodeURI(a.replace(/%25/g, "%2525")) : decodeURIComponent(a) : "" }
    ...
    function W(a, b) { this.b = this.a = null;
        this.c = a || null;
        this.f = !!b }

    function X(a) { a.a || (a.a = new dc, a.b = 0, a.c && gc(a.c, function(b, c) { a.add(decodeURIComponent(b.replace(/\+/g, " ")), c) })) }
    l = W.prototype;
    l.add = function(a, b) { X(this);
        this.c = null;
        a = Y(this, a); var c = this.a.get(a);
        c || this.a.set(a, c = []);
        c.push(b);
        this.b += 1; return this };
    ...
    function uc(a, b) { X(a);
        b = Y(a, b); return T(a.a.b, b) }
    l.forEach = function(a, b) { X(this);
        this.a.forEach(function(c, d) { ta(c, function(e) { a.call(b, e, d, this) }, this) }, this) };
    l.v = function() { X(this); for (var a = this.a.w(), b = this.a.v(), c = [], d = 0; d < b.length; d++)
            for (var e = a[d], g = 0; g < e.length; g++) c.push(b[d]); return c };
    l.w = function(a) { X(this); var b = []; if ("string" === typeof a) uc(this, a) && (b = wa(b, this.a.get(Y(this, a))));
        else { a = this.a.w(); for (var c = 0; c < a.length; c++) b = wa(b, a[c]) } return b };
    l.set = function(a, b) { X(this);
        this.c = null;
        a = Y(this, a);
    ...
    l.get = function(a, b) { if (!a) return b;
        a = this.w(a); return 0 < a.length ? String(a[0]) : b };
    l.toString = function() { if (this.c) return this.c; if (!this.a) return ""; for (var a = [], b = this.a.v(), c = 0; c < b.length; c++) { var d = b[c],
                e = encodeURIComponent(String(d));
            d = this.w(d); for (var g = 0; g < d.length; g++) { var f = e; "" !== d[g] && (f += "=" + encodeURIComponent(String(d[g])));
                a.push(f) } } return this.c = a.join("&") };

    function kc(a) { var b = new W;
        b.c = a.c;
        a.a && (b.a = new dc(a.a), b.b = a.b); return b }

    function Y(a, b) { b = String(b);
        a.f && (b = b.toLowerCase()); return b }

    function qc(a, b) { b && !a.f && (X(a), a.c = null, a.a.forEach(function(c, d) { var e = d.toLowerCase();
            d != e && (tc(this, d), tc(this, e), 0 < c.length && (this.c = null, this.a.set(Y(this, e), xa(c)), this.b += c.length)) }, a));
        a.f = b };
    E.g.D = {};
    var vc, Z, wc = null,
        xc;
    ...
    function yc() {
        ...
        b = a.get("callback");
        "string" === typeof b && (b = Ac(b), E.g.o.S().then(b));
        a = a.get("autoload");
        if ("string" === typeof a) try {
            if ("" !== a)
                for (var c = JSON.parse(a).modules, d = n(c), e = d.next(); !e.done; e = d.next()) {
                    var g = e.value;
                    zc(g.name,
                        g.version, g)
                }
        } catch (f) { throw Error("Autoload failed with: " + f); }
    }
    ...
    function Bc(a) { var b = a,
        ...
        a = b;
        do { if (b === E.g.H[b]) throw Error("Infinite loop in version mapping: " + b);
            (c = E.g.H[b]) && (b = c) } while (c);
        c = (d ? "testing-" : "") + b; return { version: "pre-45" == b ? a : c, T: c } }

    function Cc(a) { var b = E.g.N.W[xc].loader,
            c = Bc(a); return E.g.m.load(b, { version: c.T }).then(function() { var d = q("google.charts.loader.VersionSpecific.load") || q("google.charts.loader.publicLoad") || q("google.charts.versionSpecific.load"); if (!d) throw Error("Bad version: " + a);
            wc = function(e) { e = d(c.version, e); if (null == e || null == e.then) { var g = q("google.charts.loader.publicSetOnLoadCallback") || q("google.charts.versionSpecific.setOnLoadCallback");
                    e = new Promise(function(f) { g(f) });
                    e.then = g } return e } }) }

    function Dc(a, b) { b.domain = xc; if (!vc) { if (b.enableUrlSettings && window.URLSearchParams) try { a = (new URLSearchParams(top.location.search)).get("charts-version") || a } catch (c) { console.info("Failed to get charts-version from top URL", c) }
            vc = Cc(a) } return Z = vc.then(function() { return wc(b) }) }
    E.X = function(a) { return E.load(Object.assign({}, a, { safeMode: !0 })) };
    y("google.charts.safeLoad", E.X);
    E.load = function(a) { for (var b = [], c = 0; c < arguments.length; ++c) b[c] = arguments[c];
        c = 0; "visualization" === b[c] && c++; var d = "current"; "string" === typeof b[c] && (d = b[c], c++); var e = {};
        ja(b[c]) && (e = b[c]); return Dc(d, e) };
    y("google.charts.load", E.load);
    E.L = function(a) { if (!Z) throw Error("Must call google.charts.load before google.charts.setOnLoadCallback"); return a ? Z.then(a) : Z };
    y("google.charts.setOnLoadCallback", E.L);
    var Ec = D("https://maps.googleapis.com/maps/api/js?jsapiRedirect=true"),
        Fc = D("https://maps-api-ssl.google.com/maps?jsapiRedirect=true&file=googleapi");

    function Gc(a, b, c) { console.warn("Loading Maps API with the jsapi loader is deprecated.");
        c = c || {};
        a = c.key || c.client; var d = c.libraries,
            e = function(h) { var k = {};
                h = n(h); for (var m = h.next(); !m.done; m = h.next()) m = m.value, k[m[0]] = m[1]; return k }(c.other_params ? c.other_params.split("&").map(function(h) { return h.split("=") }) : []),
            g = Object.assign({}, { key: a, ga: d }, e),
            f = "2" === b ? Fc : Ec;
        Z = new Promise(function(h) { var k = Ac(c && c.callback);
            E.g.m.load(f, {}, g).then(k).then(h) }) }
    var Hc = D("https://www.gstatic.com/inputtools/js/ita/inputtools_3.js");

    function Ic(a, b, c) { ja(c) && c.packages ? ("array" == u(c.packages) ? c.packages : [c.packages]).includes("inputtools") ? (console.warn("Loading Input Tools with the jsapi loader is deprecated.\nPlease load " + (Hc + " directly.")), a = Ac(c.callback), E.g.m.load(Hc, {}).then(a)) : console.error("Loading elements other than inputtools with the jsapi loader is unsupported.") : console.error("google.load of elements was invoked without specifying packages") }
    var Jc = D("https://ajax.googleapis.com/ajax/libs/%{module}/%{version}/%{file}");

    function Kc(a, b) { var c;
        do { if (a === b[a]) throw Error("Infinite loop in version mapping for version " + a);
            (c = b[a]) && (a = c) } while (c); return a }

    function Lc(a, b, c) { var d = E.g.O.R[a]; if (d) { b = Kc(b, d.aliases);
            d = d.versions[b]; if (!d) throw Error("Unknown version, " + b + ", of " + a + "."); var e = { module: a, version: b || "", file: d.compressed };
            b = G(E.g.m.P({ format: Jc, I: e })).toString();
            console.warn("Loading modules with the jsapi loader is deprecated.\nPlease load " + (a + " directly from " + b + "."));
            Z = new Promise(function(g) { var f = Ac(c && c.callback);
                E.g.m.load(Jc, e).then(f).then(g) }) } else setTimeout(function() { throw Error('Module "' + a + '" is not supported.'); }, 0) }

    function Ac(a) { return function() { if ("function" === typeof a) a();
            else if ("string" === typeof a && "" !== a) try { q(a)() } catch (b) { throw Error("Callback failed with: " + b); } } }

    function zc(a) { for (var b = [], c = 0; c < arguments.length; ++c) b[c] = arguments[c]; switch (b[0]) {
            case "maps":
                Gc.apply(null, ba(b)); break;
            case "elements":
                Ic.apply(null, ba(b)); break;
            case "visualization":
                E.load.apply(E, ba(b)); break;
            default:
                Lc.apply(null, ba(b)) } }
    xc ? console.warn("Google Charts loader.js should only be loaded once.") : yc();
    E.g.D.fa = yc;
    E.g.D.ka = Bc;
    E.g.D.ea = function() { return wc };
}).call(this);